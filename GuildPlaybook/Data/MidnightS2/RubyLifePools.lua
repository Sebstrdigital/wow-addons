...
ns.RegisterDungeon({
  ...
  ["overview"] = {
    ...
    ["dps"] = {
      ...
      ["pullWarnings"] = {
        "Highest priorities: Ice Shield, Tectonic Slam, Roaring Blaze and Shock Blast.",
        "Switch immediately to boss adds and shields.",
        "Hard stops matter as much as interrupts.",
        "PTR route and final-trash priority list require live verification.",
        "Primal Juggernaut — Excavating Blast: Sidestep the impact and puddle.",
        "Defier Draghar — Blazing Rush: Bait toward a wall, then dodge the charge.",
